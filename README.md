...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/verspec-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12416&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/verspec-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `verspec` can be installed with:

```
conda install verspec
```

It is possible to list all of the versions of `verspec` available on your platform with:
